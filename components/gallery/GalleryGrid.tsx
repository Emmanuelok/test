...
const cuts: Cut[] = [
  ...
  { src: "/gallery/yaw-signature-fade.jpg", style: "Fade", by: "Yaw", loc: "Topsail Rd", h: "tall" },
  { src: "/gallery/mandip-kids-cut.jpg", style: "Kids", by: "Mandip", loc: "Freshwater", h: "square" },
